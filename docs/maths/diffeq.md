...
So $e^{\epsilon \mathcal{L}_1/2}e^{\epsilon \mathcal{L}_2}e^{\epsilon \mathcal{L}_1/2}$ is a good approximation of $e^{\epsilon\mathcal{L}}$, and if we have closed forms for $e^{\epsilon \mathcal{L_1}}$ and $e^{\epsilon \mathcal{L_2}}$, we can use these operators in our discretization.
