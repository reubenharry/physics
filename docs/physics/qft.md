...
Using the standard [Dirac argument](quantum.md), we represent states by the number of creation operators applied to the vacuum of $Sym(\mathbb{C}^n)$, where $n$ is the number of oscillators.
